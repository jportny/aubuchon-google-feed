...
ko.computed = ko.dependentObservable = function (evaluatorFunctionOrOptions, evaluatorFunctionTarget, options) {
    ...
    // AddEvent a "disposeWhen" callback that, on each evaluation, disposes if the node was removed without using ko.removeNode.
...
(function () {
    ...
    ko.bindingContext = function(dataItemOrAccessor, parentContext, dataItemAlias, extendCallback) {
        ...
        if (subscribable.isActive()) {
            ...
            // AddEvent properties to *subscribable* instead of *self* because any properties added to *self* may be overwritten on updates
            nodes = [];
