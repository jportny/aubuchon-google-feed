...
intellisense.annotate(_object, {
  'add': function() {
    /// <signature>
    ///   <summary>AddEvent a callback or a collection of callbacks to a callback list.</summary>
...
intellisense.annotate(_object, {
  'always': function() {
    /// <signature>
    ///   <summary>AddEvent handlers to be called when the Deferred object is either resolved or rejected.</summary>
  ...
  'done': function() {
    /// <signature>
    ///   <summary>AddEvent handlers to be called when the Deferred object is resolved.</summary>
  ...
  'fail': function() {
    /// <signature>
    ///   <summary>AddEvent handlers to be called when the Deferred object is rejected.</summary>
  ...
  'progress': function() {
    /// <signature>
    ///   <summary>AddEvent handlers to be called when the Deferred object generates progress notifications.</summary>
  ...
  'then': function() {
    /// <signature>
    ///   <summary>AddEvent handlers to be called when the Deferred object is resolved, rejected, or still in progress.</summary>
...
intellisense.annotate(jQuery.fn, {
  'add': function() {
    /// <signature>
    ///   <summary>AddEvent elements to the set of matched elements.</summary>
  ...
  'addBack': function() {
    /// <signature>
    ///   <summary>AddEvent the previous set of elements on the stack to the current set, optionally filtered by a selector.</summary>
  ...
  'andSelf': function() {
    /// <summary>AddEvent the previous set of elements on the stack to the current set.</summary>
    /// <returns type="jQuery" />
  },
  'animate': function() {
    /// <signature>
  ...
  'pushStack': function() {
    /// <signature>
    ///   <summary>AddEvent a collection of DOM elements onto the jQuery stack.</summary>
  ...
  'toggleClass': function() {
    /// <signature>
    ///   <summary>AddEvent or remove one or more classes from each element in the set of matched elements, depending on either the class's presence or the value of the switch argument.</summary>
